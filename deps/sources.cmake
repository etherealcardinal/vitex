...
if (VI_ANGELSCRIPT)
	...
	if (NOT AS_MAX_PORTABILITY IN_LIST GLOBAL_DEFINES)
		if (MSVC)
			if (CMAKE_SIZEOF_VOID_P EQUAL 8)
				if(${CMAKE_SYSTEM_PROCESSOR} MATCHES "^arm64")
					list(APPEND SOURCE "${CMAKE_CURRENT_LIST_DIR}/angelscript/sdk/angelscript/source/as_callfunc_arm64_msvc.asm")
				else()
					list(APPEND SOURCE "${CMAKE_CURRENT_LIST_DIR}/angelscript/sdk/angelscript/source/as_callfunc_x64_msvc_asm.asm")
				endif()
			elseif (${CMAKE_SYSTEM_PROCESSOR} MATCHES "arm")
				list(APPEND SOURCE "${CMAKE_CURRENT_LIST_DIR}/angelscript/sdk/angelscript/source/as_callfunc_arm_msvc.asm")
			endif()
		endif()
		if (${CMAKE_SYSTEM_PROCESSOR} MATCHES "^arm")
			list(APPEND SOURCE "${CMAKE_CURRENT_LIST_DIR}/angelscript/sdk/angelscript/source/as_callfunc_arm_gcc.S")
			list(APPEND SOURCE "${CMAKE_CURRENT_LIST_DIR}/angelscript/sdk/angelscript/source/as_callfunc_arm_vita.S")
			list(APPEND SOURCE "${CMAKE_CURRENT_LIST_DIR}/angelscript/sdk/angelscript/source/as_callfunc_arm_xcode.S")
		endif()
		if (${CMAKE_SYSTEM_PROCESSOR} MATCHES "^aarch64" OR ${CMAKE_SYSTEM_PROCESSOR} MATCHES "^arm64")
			if (APPLE)
				list(APPEND SOURCE "${CMAKE_CURRENT_LIST_DIR}/angelscript/sdk/angelscript/source/as_callfunc_arm64_xcode.S")
			else()
				list(APPEND SOURCE "${CMAKE_CURRENT_LIST_DIR}/angelscript/sdk/angelscript/source/as_callfunc_arm64_gcc.S")
			endif()
		endif()
		if (${CMAKE_SYSTEM_PROCESSOR} MATCHES "riscv64")
			list(APPEND SOURCE "${CMAKE_CURRENT_LIST_DIR}/angelscript/sdk/angelscript/source/as_callfunc_riscv64_gcc.S")
		endif()
	endif()
endif()
